  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div><h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Lead Intelligence</h1><p className="text-sm text-slate-500 font-medium">{isAdmin ? 'Global Pipeline Visibility' : 'My Active Portfolio'}</p></div>
        <div className="flex gap-2 sm:gap-3">
           ...
           <button className="flex-1 sm:flex-none px-4 sm:px-5 py-3 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl flex items-center justify-center gap-2 shadow-xl"><Plus size={16} /> Quick-Inject</button>
        </div>
      </div>

      <div className="bg-white p-3 sm:p-4 rounded-3xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-4">
